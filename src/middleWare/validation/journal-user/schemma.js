...
module.exports = {
  createSchema: Joi.object({
    roleId: Joi.string().trim().required().min(24).max(24).messages({
    ...
    userId: Joi.string().trim().required().min(24).max(24).messages({
    ...
    journalId: Joi.string().trim().required().min(24).max(24).messages({
  ...
  updateSchema: Joi.object({
    roleId: Joi.string().trim().min(24).max(24).optional().messages({
      "string.base": "roleId must be a string",
      "string.min": "roleId must be exactly 24 characters long",
      "string.max": "roleId must be exactly 24 characters long",
    }),
    userId: Joi.string().trim().min(24).max(24).optional().messages({
      "string.base": "userId must be a string",
      "string.min": "userId must be exactly 24 characters long",
      "string.max": "userId must be exactly 24 characters long",
    }),
    journalId: Joi.string().trim().min(24).max(24).optional().messages({
      "string.base": "journalId must be a string",
      "string.min": "journalId must be exactly 24 characters long",
      "string.max": "journalId must be exactly 24 characters long",
    }),
  ...
  getSchema: Joi.object({
    userId: Joi.string().trim().optional().min(24).max(24).messages({
      "string.base": "userId must be a string",
      "string.empty": "userId cannot be empty",
      "string.min": "userId must be exactly 24 characters long",
      "string.max": "userId must be exactly 24 characters long",
    }),
    journalId: Joi.string().trim().optional().min(24).max(24).messages({
      "string.base": "journalId must be a string",
